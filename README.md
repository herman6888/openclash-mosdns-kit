...
灵感来自已停更的 [herman6888/openclash-mosdns-kit](https://github.com/herman6888/openclash-mosdns-kit)（2019–2025，478★）。本 kit 把它的 DNS 分流核心（`resp_ip` 网段比对防污染 + 竞速）单独抽出来，做成 OpenClash 一键安装，去掉了原项目的其他组件依赖。
